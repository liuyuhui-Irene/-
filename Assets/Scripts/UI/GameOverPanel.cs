...
public class GameOverPanel : MonoBehaviour
{
    ...
    private void Show()
    {
        if (GameManager.Instance.GetGameScore() > GameManager.Instance.GetBestScore())
        {
            ...
            txt_BestScore.text = "Highest score  " + GameManager.Instance.GetGameScore();
        }
        else
        {
            img_New.gameObject.SetActive(false);
            txt_BestScore.text = "Highest score  " + GameManager.Instance.GetBestScore();
        }
        ...
        //Actualizar el número total de diamantes更新总的钻石数量
